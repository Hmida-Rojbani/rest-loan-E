...
@RestController
@RequestMapping("/api")
@Api(value = "LoanEligeblityIndicator", description = "service to check client eligeblity to get a bank loan")
public class LoanRestController {
	...
	@ApiResponses(value = {
			@ApiResponse(code = 200, message= "Successfuly check client status")
	})
